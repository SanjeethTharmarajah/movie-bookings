...
function showposter(data) {
  ...
  if (data.Error != "Movie not found!") {
    html1 +=
      '<div class="row"><div class="col s12 m12"><div class="card"><div class="card-image">';
    if (data.Poster != "N/A") {
      html1 +=
        '<img src="' + data.Poster + '"></div><div class="card-content">';
      imgsrc1 = data.Poster;
    } else {
      html1 +=
        '<img src="' +
    ...
    html1 +=
      '<div class="row"></div><div class="col s12"></div><div class="col s5"><div class="card"><div class="card-image">';
    html1 +=
      '<iframe id="vdobox" style="width:100%; height:400px;" src="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
    html1 +=
      '</div><div class="col s12"><div class="col s5"></div><div class="card-content"><p>Video for ' +
      data.Title.toUpperCase() +
      "</p></div></div></div></div>";
    html1 +=
      '<div class="row"></div><div class="col s12 m12"><center><button class="btn waves-effect waves-light shadow" onclick="showmodal()">Book Ticket</button></center></div></div>';
    ...
    html1 += " </div></div></div></div>";
    html1 +=
      '<div class="row"></div><div class="col s12 m12"><div class="card"><div class="card-image">';
    resultsEl.innerHTML = "";
    resultsEl.innerHTML = html1;
  }
...
function showmodal() {
  ...
  html3 +=
    '<p><font color="white">&nbsp;&nbsp;Title: ' + title1 + "</font></p>";
  html3 +=
    '<p><font color="white">&nbsp;&nbsp;Year: ' + movieyear1 + "</font></p>";
